...
const BioSection = ({darkMode}) => {
  return (
    ...
    <div className=' flex justify-center lg:p-12 max-md:p-4 pt-20 max-md:pt-16 '>

    <div className={`${darkMode ?'bg-[#7021c5] text-white':'bg-[#FFBF1C] text-[#544c3b]'} rounded-l-md lg:w-[50%] lg:p-8 max-md:p-4 `}>
    ...
    <div className={`${darkMode?"bg-[#7021c5]":"bg-[#FFBF1C]"} max-md:hidden rounded-r-md w-[40.5%]`}>
