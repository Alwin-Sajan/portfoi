...
const Home = () => {
  ...
  return (
    <>
      <div className={`h-auto Main relative w-full  ${darkMode ? 'bg-[#0b0b0b] text-white ' : 'bg-white text-black '}`}>
        ...
        <div className={`w-full ${darkMode ? 'bg-[#272217]' : 'bg-[#ffbf1c]'} flex flex-col-reverse lg:flex-row items-center  max-md:pt-32 max-md:h-[75vh]  justify-between px-6 lg:px-28 py-14 lg:py-0 lg:h-[85vh]`}>
          ...
          <div className={`text-center lg:text-left w-full lg:w-1/2 z-10 ${darkMode ? 'text-white' : 'text-[#544c3b]'}`}>
            <Reveal>
              ...
              <p className="text-base md:text-lg lg:text-xl max-w-xl mx-auto lg:mx-0 mb-6 leading-relaxed font-light">
          ...
          <Reveal>
            <div className="mb-10 lg:mb-0 flex items-center justify-center relative overflow-visible">
              {/* Desktop animation */}
              <motion.div
              ...
              >
                <img
                  ...
                  alt="Alwin Sajan"
                  className={`w-40 md:w-72 lg:w-72 rounded-full border-4 md:border-8 ${darkMode ? 'border-[#7021c5]' : 'border-[#4a3f2f]'}`}
                />
              </motion.div>
              ...
              <div className="block md:hidden ">
                <img
                  src="https://avatars.githubusercontent.com/u/116751380?v=4"
                  alt="Alwin Sajan"
                  className={`w-72 md:w-72 lg:w-72 rounded-full border-4 md:border-8 ${darkMode ? 'border-[#7021c5]' : 'border-[#4a3f2f]'}`}
                />
              </div>
            </div>
          </Reveal>
